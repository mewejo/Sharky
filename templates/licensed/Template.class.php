...
{	
	...
	function __construct()
	{
		...
		$this->_LManage = new BTSharkBTSWVD(Shark::_GetModulesConfig($this->_ModuleShortName, "LicenseKey"), dirname(__FILE__), $this->_ModuleShortName, $this->_ModuleVersion);
	}
	...
	{
		if($this->_LManage->ValidateLicense() !== true) return "Invalid license";
	...
	{
		if($this->_LManage->ValidateLicense() !== true) return $this->_AO_FatalError("Invalid license - Please contact Bluetip Support or enter your new license in the modules configuration");
